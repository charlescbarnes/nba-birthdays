...
Running the main method in NbaBirthdaysDriver.java will output a 
prompt informing the user of:
...
code saved to text files (one per team), e.g., ATL.txt, BOS.txt, etc. 
The user will not be interested in viewing these files.
...
the game has occurred since the date of last retrieval, and they want
